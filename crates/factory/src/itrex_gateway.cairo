...
pub trait ITREXGateway<TContractState> {
    ...
    fn set_deployment_fee(ref self: TContractState, fee: u256, fee_token: ContractAddress, fee_collector: ContractAddress);
    ...
    fn batch_apply_fee_discount(ref self: TContractState, deployers: Array<ContractAddress>, discounts: Array<u16>);
    fn deploy_TREX_suite(ref self: TContractState, token_details: TokenDetails, claim_details: ClaimDetails);
    fn batch_deploy_TREX_suite(ref self: TContractState, token_details: Array<TokenDetails>, claim_details: Array<ClaimDetails>);
