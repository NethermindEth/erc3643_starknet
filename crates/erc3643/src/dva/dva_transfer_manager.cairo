...
pub mod DVATransferManager {
    ...
    use crate::dva::idva_transfer_manager::IDVATransferManager;
    use crate::dva::idva_transfer_manager::{
        ApprovalCriteria, ApprovalCriteriaStore, ApprovalCriteriaStoreStorageNode,
    };
    use crate::dva::idva_transfer_manager::{Approver, Errors, Events::*, TransferStatus};
    use crate::dva::idva_transfer_manager::{DelegatedApproval, DelegatedApprovalMessage};
    use crate::dva::idva_transfer_manager::{
