use crate::registry::interface::itrusted_issuers_registry::ITrustedIssuersRegistryDispatcher;
...
pub mod get_trusted_issuers {
    use crate::registry::interface::itrusted_issuers_registry::ITrustedIssuersRegistryDispatcherTrait;
    use super::setup;
