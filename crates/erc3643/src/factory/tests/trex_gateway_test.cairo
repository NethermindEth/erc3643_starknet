...
use crate::factory::{
    ...
    itrex_gateway::ITREXGatewayDispatcher, trex_factory::TREXFactory, trex_gateway::TREXGateway,
};
use crate::registry::interface::iidentity_registry::IIdentityRegistryDispatcherTrait;
use crate::roles::agent_role::{IAgentRoleDispatcher, IAgentRoleDispatcherTrait};
...
pub mod set_factory {
    ...
    use crate::factory::{itrex_gateway::ITREXGatewayDispatcherTrait, trex_gateway::TREXGateway};
    use snforge_std::{
...
pub mod transfer_factory_ownership {
    use crate::factory::itrex_gateway::ITREXGatewayDispatcherTrait;
...
pub mod deploy_trex_suite {
    ...
    use test_commons::mocks::mock_erc20::{IMintableDispatcher, IMintableDispatcherTrait};
