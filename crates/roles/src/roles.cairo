// we might utilize or modify https://github.com/OpenZeppelin/cairo-contracts/blob/main/packages/access/src/accesscontrol/accesscontrol.cairo
...
pub mod RolesComponent {
    ...
    pub impl RolesImpl<TContractState, +HasComponent<TContractState>, +Drop<TContractState>> of super::IRoles<ComponentState<TContractState>> {
        ...
        fn has(self: @ComponentState<TContractState>, account: ContractAddress) -> bool {
            assert!(account != starknet::contract_address_const::<0>(), "Roles: account is the zero address");
