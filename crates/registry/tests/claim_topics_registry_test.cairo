use registry::interface::iclaim_topics_registry::IClaimTopicsRegistryDispatcher;
...
pub mod get_claim_topics {
    use registry::interface::iclaim_topics_registry::IClaimTopicsRegistryDispatcherTrait;
    use super::setup;
