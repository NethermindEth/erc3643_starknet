...
pub trait IDVATransferManager<TContractState> {
    fn set_approval_criteria(ref self: TContractState, token_address: ContractAddress, include_recipient_approver: bool, include_agent_approver: bool, sequantial_approval: bool, additional_approvers: Array<ContractAddress>);
    fn initiate_transfer(ref self: TContractState, token_address: ContractAddress, recipient: ContractAddress, amount: u256);
    fn approve_transfer(ref self: TContractState, transfer_id: felt252);
    fn delegate_approve_transfer(ref self: TContractState, transfer_id: felt252, signatures: Array<Signature>);
    ...
    fn get_approval_criteria(self: @TContractState, token_address: ContractAddress) -> ApprovalCriteria;
    ...
    fn calculate_transfer_id(self: @TContractState, nonce: u256, sender: ContractAddress, recipient: ContractAddress, amount: u256) -> felt252;
}